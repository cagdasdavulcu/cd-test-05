...
3. Give the bot a handle (ex: `cdTest05Bot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://cdtest05.azurewebsites.net/api/messages`
