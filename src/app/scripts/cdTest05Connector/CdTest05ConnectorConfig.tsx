...
export interface ICdTest05ConnectorConfigState extends ITeamsBaseComponentState {
...
export interface ICdTest05ConnectorConfigProps extends ITeamsBaseComponentProps {
}
...
/**
 * Implementation of the cdTest05Connector Connector connect page
 */
export class CdTest05ConnectorConfig extends TeamsBaseComponent<ICdTest05ConnectorConfigProps, ICdTest05ConnectorConfigState> {
        ...
        if (this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/cdTest05Connector/config.html`,
